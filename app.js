...
// ============================================================================
const TASKS_SRC = [
  { phase: "エスキス", name: "読み取り1回目（赤ペン / 全体像の把握）", std: 20 },
  { phase: "エスキス", name: "読み取り2回目（ピンク・黄マーカー）", std: 10 },
  { phase: "エスキス", name: "けさのぼたんえびの確認（青ペン）", std: 1 },
  { phase: "エスキス", name: "条件整理 / コマ出し", std: 12 },
  { phase: "エスキス", name: "立体構成の整理（断面パターン / 高さ制限）", std: 5 },
  { phase: "エスキス", name: "アプローチ・敷地利用計画（1/1000）", std: 5 },
  { phase: "エスキス", name: "建築可能範囲の把握（1/1000）", std: 4 },
  { phase: "エスキス", name: "グリッドの想定 / 基準階の検討（倍コマ）", std: 8 },
  { phase: "エスキス", name: "建物ボリュームの検討（床面積 / 空間）", std: 4 },
  { phase: "エスキス", name: "ラフプラン1（基準階配置・ゾーニング）", std: 6 },
  { phase: "エスキス", name: "ラフプラン2（グルーピング・室配置）", std: 6 },
  { phase: "エスキス", name: "倍コマ後のチェック（面積 / ピンク条件違反）", std: 5 },
  { phase: "エスキス", sheet: "1/400エスキス", name: "プランの清書", std: 60 },
  { phase: "エスキス", name: "エスキス終了後チェック（法規 / 漏れ落ち）", std: 10 },
  ...
  { phase: "見直し", name: "最終チェック（法規 / 条件の漏れ落ち）", std: 20 },
  { phase: "見直し", name: "最終チェック（黄マーカー / 作図の漏れ）", std: 10 },
];
